$(function() {
    ...
    function bindBtnEvent() {
         ...
         * 行内"预览"按钮功能实现
         */
        $linkPreview.unbind().on('click', function() {
            var $this = $(this);
        ...
        $linkModify.unbind().on('click', function() {
            var $this = $(this);
        ...
        $linkDelete.unbind().on('click', function() {
            var $this = $(this);
            var id = $($this.parents("tr").children()[1]).html();
            if (confirm("确定要删除该文章？")) {
        ...
        $linkThumbnails.unbind().on('click', function() {
        ...
        $deleteCommitBtn.on('click', function() {
            ...
            $.ajax({
                url: "/_admin/s/article/articles/delete",
                type: "POST",
                data: {
                    ids: deleteIds
                },
